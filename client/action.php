  ...
  <script type="text/html" id="listinit">
    {{each items item}}
      <div>
        ...
        <div class="row container-fauid" style="margin:0 auto;">
...
<body>
      ...
      <div class="container row">    
        ...
        <div class="collapse navbar-collapse navbar-right" id="navBar">    
          <ul class="nav navbar-nav small">  
            ...
            <li class="active"><a href="#">街区活动</a></li>  
  ...
  <div class="title">
    ...
    <div class="container-fauid row content">
  		<div class=" col-xs-3">
  			<div class="col-xs-6 col-xs-offset-2 col-sm-offset-5 col-md-offset-4 col-lg-offset-6 ">
  				<ul class="nav nav-pills nav-stacked ">
  					<li class="active">
  						<a href="#">街区活动</a>
              <ul class="nav nav-pills nav-stacked ">
                <li><a href="#" class="small">街区活动</a></li>
              </ul>
  					</li>
  				</ul>
  			</div>
  		</div>
		  <div class="col-xs-7 col-lg-8 col-xs-offset-1 col-md-offset-0 action-list">
          <div class="path">
            <ol class="breadcrumb">
              <li><a href="home.php">首页</a></li>
              <li><a href="#">街区活动</a></li>
