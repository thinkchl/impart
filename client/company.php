  ...
  <script type="text/html" id="listinit">
    {{each items item}}
      <div>
        ...
        <div class="row">
          <img src="../admin/{{item.img}}" class="img-responsive img-circle col-xs-3" alt="" style="margin-left: 0.2rem;">
          <div class="col-xs-8">
            <p>{{item.content}}</p>
            <p>{{item.createdate}}</p>
          </div>
...
<body>
      ...
      <div class="container row">    
        ...
        <div class="collapse navbar-collapse navbar-right" id="navBar">    
          <ul class="nav navbar-nav small">  
            ...
            <li class="active"><a href="#">入驻机构</a></li>  
    ...
    <div class="container-fauid row content">
      <div class="content-left col-xs-3 ">
        <div class=" col-md-6 col-xs-offset-3  col-sm-offset-4  col-md-offset-6">
          <ul class="nav nav-pills nav-stacked ">
            <li class="active">
              <a href="news.html">入驻机构</a>
              <ul class="nav nav-pills nav-stacked ">
                <li><a href="#" class="small">入驻机构</a></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <div class="col-xs-7 col-lg-8 col-xs-offset-1 col-md-offset-0 list">
          <div class="path">
            <ol class="breadcrumb">
              <li><a href="home.php">首页</a></li>
              <li><a href="#">入住机构</a></li>
